...
const user_1 = require("../../models/user"); // Fixed import
const errors_1 = require("../../models/errors"); // Fixed import
...
router.get("/available-money/:userID", exports.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res.json({ availableMoney: user.availableMoney || 0 });
    }
    catch (err) {
        return res.status(500).json({ error: "Error retrieving available money" });
    }
}));
